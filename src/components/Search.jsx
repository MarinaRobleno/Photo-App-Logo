      ...
      <ThemeProvider theme={theme}>
        ...
        <div>
          {json.length > 0 ? (
                    ...
                    <ImageListItemBar
                      ...
                      subtitle={
                        <Button
                          ...
                          variant="contained"
                          color="myBlue"
                          disabled={myImages.photosObj[image.id]}
            ...
            <img
              className="animate__animated animate__pulse animate__infinite animate__slower logo-background"
              src="https://fontmeme.com/permalink/211116/74e2fb54a3d637e8cd3f7b92480913a8.png"
